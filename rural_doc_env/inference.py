...
from rural_doc_env.models import Observation
...
def call_llm(system_prompt: str, conversation: list[dict]) -> str:
    """
    Send the conversation to an LLM and return the raw text response.

    Replace this stub with your actual inference call. The conversation is
    a list of {"role": "user"|"assistant", "content": str} dicts. The system
    ...
    raise NotImplementedError(
        "Replace call_llm() with your actual LLM inference backend.\n"
